...
export class EmployeeService {
  ...
  getEmployeeById(id: number): Observable<any> {
    ...
    return this.http.get(`http://localhost:9091/emp/getEmployeeByID/${id}`, { headers });
  }
  ...
  getAllEmployees(): Observable<any> {
    ...
    return this.http.get(`http://localhost:9091/emp/getAllEmployees`,{ headers });
  }
  ...
  addEmployee(employeeData: any, imageFiles: File[]): Observable<any> {
    ...
    return this.http.post<Employee>('http://localhost:9091/emp/addEmployee', formData, { headers });
  }
  ...
  updateEmployee(id: number, employeeData: Employee, imageFiles: File[]): Observable<any> {
    ...
    // Make the HTTP request
    return this.http.put<Employee>(`http://localhost:9091/emp/updateEmployee/${id}`, formData, { headers });
  }
  ...
  deleteEmployee(id: number): Observable<any> {
    ...
    return this.http.delete(`http://localhost:9091/emp/deleteEmployeeById/${id}`, { headers });
  }
  ...
  getByTeam(idteam: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:9091/emp/EmployeeByIdTeam/${idteam}`,{ headers });
  }
  getTeams(): Observable<any> {
    ...
    return this.http.get('http://localhost:9091/team/getAllTeams',{ headers });
  }
  countEmployees(): Observable<number> {
    return this.http.get<number>(`http://localhost:9091/emp/count`);
  }
}